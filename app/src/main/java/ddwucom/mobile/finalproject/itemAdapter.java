...
public class itemAdapter extends BaseAdapter {
    ...
    public itemAdapter(Context context, int resource, ArrayList<ItemSearchInfoDTO> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.d(TAG, "getView with postion : "+ position);
...
//            viewHolder = new ViewHolder();
            //어댑터에 들어갈 항목들 findViewById(R.id.) 해주기
//            viewHolder.
//
//            view.setTag(viewHolder);
        ...
        // 어댑터에 들어갈 항목들 setText해주기 Setting
        // viewHolder.
...
//        if(dto.getImageLink() == null){ //이미지의 링크가 null 일때!
...
//        public ImageView ivImage = null;
    ...
    /* 이미지를 다운로드 후 내부저장소에 파일로 저장하고 이미지뷰에 표시하는 AsyncTask */
    // 1. 네트워크에서 이미지 다운
    // 2. 뷰홀더에 이미지 설정
    // 3. 이미지 파일 저장
